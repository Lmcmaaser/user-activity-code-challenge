<template>
  <div id="page_two">
    <header>
      <h1>Users with a login count greater than or equal to 1</h1>
    </header>
    <table>
    ...
    <section>
      <p>
        Click the button to highlight all user rows with a login count of 0
      <p/>
      <input
        id="button"
        type="button" 
      ...
      <!-- v-on:click listen to DOM events and run some JavaScript when they’re triggered. -->
    </section>
  </div>
</template>
